...
public class Constants {
    ...
    public static final String Title="断熱境界条件：P.20：Fortran77による伝熱解析プログラム（中村博 著）：サイエンス社";
    public static final int Nx = 5;
    public static final int Ny = 10;
    public static final double xLen = 0.6;
    ...
    //
    public static final String PATH = "./thermalconduction02/data/";
